! function(e) {
...
}([function(e, t, n) { n(1), n(3), n(25), e.exports = n(27) }, function(e, t, n) {
    var o = n(2);
    Y.use("node", function(e) {
        window.Singleton.create({
            ...
            initializer: function() { return this.el = e.one(".show-on-scroll"), this.el ? (this.elOffset = e.one(this.el.getData("offset-el")), this.offsetBehavior = this.el.getData("offset-behavior") || "top", this.elOffset ? (e.one("body").prepend(e.Node.create('<div class="show-on-scroll-wrapper" id="showOnScrollWrapper"></div>')), this.wrapper = e.one("#showOnScrollWrapper"), this.wrapper.setHTML(this.el._node.outerHTML), void 0) : void console.warn("No show on scroll offset element found.")) : void console.warn("No show on scroll element found.") },
            bindUI: function() { this.scrollEvents(), e.one(window).on("resize", function() { this.syncUI() }, this) },
            syncUI: function() { this.getVariables() },
            getVariables: function() { "bottom" === this.offsetBehavior ? this.navShowPosition = this.elOffset.getY() + this.elOffset.get("offsetHeight") : this.navShowPosition = this.elOffset.getY() },
            scrollEvents: function() { this.scrolling = !1, e.one(window).on("scroll", function() { this.scrolling === !1 && (this.scrolling = !0, this.scrollLogic(), o(function() { this.scrolling = !1 }, 300, this)) }, this) },
            scrollLogic: function() { window.pageYOffset > this.navShowPosition ? this.wrapper.addClass("show") : this.wrapper.removeClass("show"), e.later(100, this, function() { this.scrolling === !0 && window.requestAnimationFrame(e.bind(function() { this.scrollLogic() }, this)) }) }
        })
    })
}, function(e, t) {
    ...
    Y.use(["node", "squarespace-gallery-ng"], function(e) {
        window.Singleton.create({
            ready: function() { this.resetGalleryPosition(), e.one(".collection-type-index") && this.resetIndexGalleryPosition(), e.one(".collection-type-blog.view-list .sqs-featured-posts-gallery") && e.one("body").addClass("has-banner-image"), this.init(), this.bindUI(), this.syncUI() },
            init: function() {
            ...
            setupUserAccountLinks: function() {
                e.all(".user-account-link").each(function(e) {
                    var t = o.isUserAuthenticated() ? ".unauth" : ".auth",
                        n = e.one(t);
                    n.remove(), e.on("click", function(e) { e.preventDefault(), o.openAccountScreen() })
                })
            },
            bindUI: function() {
                e.one(window).on("resize", this.syncUI, this), e.all(".mobile-nav-toggle, .body-overlay").each(function(t) { t.on("click", function() { e.one("body").toggleClass("mobile-nav-open") }) });
                ...
                e.all(n).each(function(t) { t.on("click", function(t) { e.one("body").removeClass("mobile-nav-open") }, this) }, this), this.showIndexNavOnScroll(), this.disableHoverOnScroll()
            },
            syncUI: function() { this.forceMobileNav(), r(function() { this.addPaddingToFooter() }, 100, this) },
            ...
            resetIndexGalleryPosition: function() {
                ...
                o && e.one("body").addClass("has-banner-image"), e.one(t) && (e.one("body").addClass("has-promoted-gallery"), e.all(n).each(function(e) { e.one(".sqs-gallery-block-slideshow") && e.ancestor(".index-section-wrapper").previous(".promoted-gallery-wrapper").addClass("promoted-full").append(e) }))
            },
            ...
            disableHoverOnScroll: function() {
                ...
                var t, n = ".disable-hover:not(.sqs-layout-editing), .disable-hover:not(.sqs-layout-editing) * { pointer-events: none  ; }",
                    ...
                    i = document.body;
                r.type = "text/css", r.styleSheet ? r.styleSheet.cssText = n : r.appendChild(document.createTextNode(n)), o.appendChild(r), window.addEventListener("scroll", function() { clearTimeout(t), i.classList.contains("disable-hover") || i.classList.add("disable-hover"), t = setTimeout(function() { i.classList.remove("disable-hover") }, 300) }, !1)
            }
        })
    })
}, function(e, t) {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), t.videoAutoplayTest = t.VideoFilterPropertyValues = t.VideoBackground = void 0, n(7);
    var o = n(8);
    ...
    function o(e) { return e && e.__esModule ? e : { default: e } } Object.defineProperty(t, "__esModule", { value: !0 }), t.videoAutoplayTest = t.VideoFilterPropertyValues = t.VideoBackground = void 0;
    var r = n(9),
        i = o(r),
        a = n(23),
        s = n(12),
    ...
    var i = function() {
        ...
        y = function() {
            ...
            return i(e, [{ key: "destroy", value: function() { this.events && this.events.forEach(function(e) { return e.target.removeEventListener(e.type, e.handler, !0) }), this.events = null, this.player && "function" == typeof this.player.destroy && (this.player.iframe.classList.remove("ready"), clearTimeout(this.playTimeout), this.playTimeout = null, this.player.destroy(), this.player = {}), "number" == typeof this.timer && (clearTimeout(this.timer), this.timer = null) } }, {
                ...
                value: function() {
                    var e = this;
                    if (this.player.ready) { try { this.player.destroy() } catch (e) {} this.player.ready = !1 }
                ...
                value: function() {
                    ...
                    return void 0 === t && (this.logger("test video autoplay: begin"), this.playTimeout && (clearTimeout(this.playTimeout), this.playTimeout = null), this.playTimeout = setTimeout(function() { e.testVideoEmbedAutoplay(!1) }, A.TIMEOUT)), t === !0 ? (clearTimeout(this.playTimeout), this.logger("test video autoplay: success"), this.playTimeout = null, this.videoCanAutoPlay = !0, this.player.ready = !0, this.player.iframe.classList.add("ready"), void this.container.classList.remove("mobile")) : t === !1 ? (clearTimeout(this.playTimeout), this.logger("test video autoplay: failure"), this.playTimeout = null, this.videoCanAutoPlay = !1, void this.renderFallbackBehavior()) : void 0
                }
            }, { key: "renderFallbackBehavior", value: function() { this.setFallbackImage(), this.container.classList.add("mobile"), this.logger("added mobile") } }, { key: "syncPlayer", value: function() { this.setDisplayEffects(), this.setSpeed(), this.scaleVideo() } }, {
                key: "scaleVideo",
                value: function(e) {
            ...
            }, { key: "setSpeed", value: function(e) { this.playbackSpeed = parseFloat(this.playbackSpeed), this.player.setPlaybackRate && this.player.setPlaybackRate(this.playbackSpeed) } }, { key: "setDisplayEffects", value: function() { this.setFilter() } }, {
                key: "setFilter",
                value: function() {
                    ...
                    var o = "blur" === t;
                    e.webkitFilter = o ? "" : n, e.filter = o ? "" : n, this.container.classList.toggle("filter-blur", o), Array.prototype.slice.call(this.container.children).forEach(function(e) { e.style.webkitFilter = o ? n : "", e.style.filter = o ? n : "" })
                }
            }, { key: "getFilterStyle", value: function(e, t) { return e + "(" + (f.filterProperties[e].modifier(t) + f.filterProperties[e].unit) + ")" } }, { key: "logger", value: function(e) { this.DEBUG.enabled && this.DEBUG.verbose && this.windowContext.console.log(e) } }]), e
        }();
    t.default = y
}, function(e, t, n) {
    (function(e, n) {
        ...
        function a(e, t) { for (var n = -1, o = e ? e.length : 0; ++n < o && t(e[n], n, e) !== !1;); return e }

        function s(e, t) { for (var n = -1, o = t.length, r = e.length; ++n < o;) e[r + n] = t[n]; return e }
        ...
        function c(e, t) { for (var n = -1, o = Array(e); ++n < e;) o[n] = t(n); return o }
        ...
        function g() { this.__data__ = rn ? rn(null) : {} }

        function v(e) { return this.has(e) && delete this.__data__[e] }

        function m(e) { var t = this.__data__; if (rn) { var n = t[e]; return n === De ? void 0 : n } return Gt.call(t, e) ? t[e] : void 0 }

        function b(e) { var t = this.__data__; return rn ? void 0 !== t[e] : Gt.call(t, e) }

        function w(e, t) { var n = this.__data__; return n[e] = rn && void 0 === t ? De : t, this }
        ...
        function _(e) { return L(this.__data__, e) > -1 }
        ...
        function I() { this.__data__ = { hash: new y, map: new(en || E), string: new y } }

        function R(e) { return pe(this, e).delete(e) }

        function C(e) { return pe(this, e).get(e) }

        function F(e) { return pe(this, e).has(e) }

        function V(e, t) { return pe(this, e).set(e, t), this }

        function B(e) { this.__data__ = new E(e) }

        function Y() { this.__data__ = new E }

        function j(e) { return this.__data__.delete(e) }

        function U(e) { return this.__data__.get(e) }

        function G(e) { return this.__data__.has(e) }
        ...
        function Q(e, t) { return e && de(t, Ue(t), e) }
        ...
        function Z(e, t, n, o, r, i, s) {
            ...
            if (!Ve(e)) return e;
            var c = pn(e);
            if (c) { if (l = ge(e), !t) return ue(e, l) } else {
                var u = hn(e),
                    d = u == qe || u == Je;
                if (yn(e)) return ne(e, t);
                if (u == $e || u == Qe || d && !i) { if (A(e)) return i ? e : {}; if (l = ve(d ? {} : e), !t) return Ae(e, Q(l, e)) } else {
                    if (!Et[u]) return i ? e : {};
                    l = me(e, u, Z, t)
                }
            }
            ...
            return a(h || e, function(r, i) { h && (i = r, r = e[i]), D(l, i, Z(r, t, n, o, i, e, s)) }), l
        }

        function H(e) { return Ve(e) ? Ht(e) : {} }

        function W(e, t, n) { var o = t(e); return pn(e) ? o : s(o, n(e)) }

        function z(e) { return Mt.call(e) }

        function q(e) { if (!Ve(e) || Te(e)) return !1; var t = Ce(e) || A(e) ? Nt : mt; return t.test(_e(e)) }

        function J(e) { return Be(e) && Fe(e.length) && !!wt[Mt.call(e)] }

        function X(e) { if (!ke(e)) return Xt(e); var t = []; for (var n in Object(e)) Gt.call(e, n) && "constructor" != n && t.push(n); return t }
        ...
        function oe(e) { var t = new e.constructor(e.byteLength); return new Qt(t).set(new Qt(e)), t }

        function re(e, t) { var n = t ? oe(e.buffer) : e.buffer; return new e.constructor(n, e.byteOffset, e.byteLength) }

        function ie(e, t, n) { var r = t ? n(f(e), !0) : f(e); return l(r, o, new e.constructor) }

        function ae(e) { var t = new e.constructor(e.source, vt.exec(e)); return t.lastIndex = e.lastIndex, t }

        function se(e, t, n) { var o = t ? n(p(e), !0) : p(e); return l(o, r, new e.constructor) }

        function le(e) { return An ? Object(An.call(e)) : {} }

        function ce(e, t) { var n = t ? oe(e.buffer) : e.buffer; return new e.constructor(n, e.byteOffset, e.length) }
        ...
        function Ae(e, t) { return de(e, fn(e), t) }
        ...
        function he(e) { return W(e, Ue, fn) }

        function pe(e, t) { var n = e.__data__; return Ee(t) ? n["string" == typeof t ? "string" : "hash"] : n.map }

        function ye(e, t) { var n = d(e, t); return q(n) ? n : void 0 }
        ...
        function ve(e) { return "function" != typeof e.constructor || ke(e) ? {} : H(Zt(e)) }
        ...
        function be(e, t) { return t = null == t ? Le : t, !!t && ("number" == typeof e || bt.test(e)) && e > -1 && e % 1 == 0 && e < t }

        function we(e, t, n) { if (!Ve(n)) return !1; var o = typeof t; return !!("number" == o ? Ie(n) && be(t, n.length) : "string" == o && t in n) && xe(n[t], e) }

        function Ee(e) { var t = typeof e; return "string" == t || "number" == t || "symbol" == t || "boolean" == t ? "__proto__" !== e : null === e }

        function Te(e) { return !!jt && jt in e }
        ...
        function _e(e) { if (null != e) { try { return Ut.call(e) } catch (e) {} try { return e + "" } catch (e) {} } return "" }

        function xe(e, t) { return e === t || e !== e && t !== t }

        function Pe(e) { return Re(e) && Gt.call(e, "callee") && (!Wt.call(e, "callee") || Mt.call(e) == Qe) }

        function Ie(e) { return null != e && Fe(e.length) && !Ce(e) }

        function Re(e) { return Be(e) && Ie(e) }

        function Ce(e) { var t = Ve(e) ? Mt.call(e) : ""; return t == qe || t == Je }

        function Fe(e) { return "number" == typeof e && e > -1 && e % 1 == 0 && e <= Le }

        function Ve(e) { var t = typeof e; return !!e && ("object" == t || "function" == t) }

        function Be(e) { return !!e && "object" == typeof e }

        function Ye(e) { if (!Be(e) || Mt.call(e) != $e || A(e)) return !1; var t = Zt(e); if (null === t) return !0; var n = Gt.call(t, "constructor") && t.constructor; return "function" == typeof n && n instanceof n && Ut.call(n) == Ot }

        function je(e) { return de(e, Ge(e)) }

        function Ue(e) { return Ie(e) ? M(e) : X(e) }

        function Ge(e) { return Ie(e) ? M(e, !0) : K(e) }
        ...
        var Tt = "object" == typeof e && e && e.Object === Object && e,
            ...
            Pt = xt && xt.exports === _t,
            It = Pt && Tt.process,
            Rt = function() { try { return It && It.binding("util") } catch (e) {} }(),
            Ct = Rt && Rt.isTypedArray,
            Ft = Array.prototype,
            Vt = Function.prototype,
            Bt = Object.prototype,
            Yt = St["__core-js_shared__"],
            jt = function() { var e = /[^.]+$/.exec(Yt && Yt.keys && Yt.keys.IE_PROTO || ""); return e ? "Symbol(src)_1." + e : "" }(),
            Ut = Vt.toString,
        ...
        var pn = Array.isArray,
            yn = Jt || Me,
            gn = Ct ? u(Ct) : J,
            vn = fe(function(e, t, n) { $(e, t, n) });
        n.exports = vn
    }).call(t, function() { return this }(), n(11)(e))
    ...
    var o = !1,
        ...
        s = function() {
            return new Promise(function(e, t) {
                ...
                var r = null,
                    s = function() { r && (clearTimeout(r), r = null); try { document.body.removeChild(n) } catch (e) { return } };
                try {
    ...
    var o = n(15),
        ...
        a = "*",
        s = null,
        l = function() { return new Promise(function(e, t) { e("no api needed") }) },
        c = function(e, t) {
            var n = { method: e };
            t && (n.value = t);
        ...
        u = function(e) {
            ...
            return new Promise(function(e, h) {
                ...
                e(v);
                var m = function() { c("getDuration"), c("getVideoHeight"), c("getVideoWidth") },
                    b = null,
                    w = function() {
                    ...
                    E = function() { s && (clearTimeout(s), s = null), v.dimensions || (v.dimensions = {}, m(), f("buffering"), b = setTimeout(function() { p.call(n, "retrying"), w(!0) }, .75 * r.TIMEOUT)) },
                    T = function(e) {
                    ...
                    k = function(e) { T(e) };
                t.addEventListener("message", k, !1), v.destroy = function() { t.removeEventListener("message", k), v.iframe.parentElement && v.iframe.parentElement.removeChild(v.iframe) }, s = setTimeout(function() { h("Ran out of time") }, r.TIMEOUT)
            })
        };
    ...
    function o(e) { return e && e.__esModule ? e : { default: e } } Object.defineProperty(t, "__esModule", { value: !0 }), t.validatedImage = t.getVideoSource = t.getVideoID = t.getStartTime = t.getPlayerElement = t.findPlayerAspectRatio = void 0;
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) { return typeof e } : function(e) { return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e },
        ...
        u = function(e) {
            var t = void 0,
                n = void 0;
            for (var o in e) { var i = e[o]; if ("object" === ("undefined" == typeof i ? "undefined" : r(i)) && i.width && i.height) { t = i.width, n = i.height; break } }
            return { w: t, h: n }
        },
        d = function(e) {
            var t = void 0,
        ...
        A = { youtube: { parsePath: "query.t", timeRegex: /[hms]/, idRegex: i.YOUTUBE_REGEX, getDimensions: u }, vimeo: { parsePath: null, timeRegex: /[#t=s]/, idRegex: i.VIMEO_REGEX, getDimensions: d } },
        f = function(e, t) { return A[t].parsePath ? (0, c.default)(e, A[t].parsePath) : null },
        h = function(e, t) {
        ...
        g = function(e) { if (!e) return !1; var t = "IMG" === e.nodeName && e; return t || console.warn("Element is not a valid image element."), t },
        v = function(e, t, n) {
            var o = void 0,
                r = void 0;
            if (t) {
        ...
        m = function(e) { var t = e.querySelector("#player"); return t || (t = e.ownerDocument.createElement("div"), t.id = "player", e.appendChild(t)), t.setAttribute("style", "position: absolute; top: 0; bottom: 0; left: 0; right: 0;"), t };
    ...
    function o(e) { var t = c.exec(e); return { protocol: t[1] ? t[1].toLowerCase() : "", slashes: !!t[2], rest: t[3] ? t[3] : "" } }
    ...
    r.prototype.set = function(e, t, n) { var o = this; return "query" === e ? ("string" == typeof t && t.length && (t = (n || s.parse)(t)), o[e] = t) : "port" === e ? (o[e] = t, i(t, o.protocol) ? t && (o.host = o.hostname + ":" + t) : (o.host = o.hostname, o[e] = "")) : "hostname" === e ? (o[e] = t, o.port && (t += ":" + o.port), o.host = t) : "host" === e ? (o[e] = t, /\:\d+/.test(t) && (t = t.split(":"), o.hostname = t[0], o.port = t[1])) : "protocol" === e ? (o.protocol = t, o.slashes = !n) : o[e] = t, o.href = o.toString(), o }, r.prototype.toString = function(e) {
    ...
    (function(t) {
        ...
        e.exports = function(e) {
            ...
            else if ("string" === l) { s = new o(e, {}); for (a in i) delete s[a] } else if ("object" === l) {
    ...
    function n(e) { for (var t, n = /([^=?&]+)=?([^&]*)/g, o = {}; t = n.exec(e); o[decodeURIComponent(t[1])] = decodeURIComponent(t[2])); return o }
    ...
    (function(t) {
        ...
        function s(e) { var t = this.__data__; if (ye) { var n = t[e]; return n === L ? void 0 : n } return ue.call(t, e) ? t[e] : void 0 }

        function l(e) { var t = this.__data__; return ye ? void 0 !== t[e] : ue.call(t, e) }

        function c(e, t) { var n = this.__data__; return n[e] = ye && void 0 === t ? L : t, this }
        ...
        function h(e) { return E(this.__data__, e) > -1 }
        ...
        function g() { this.__data__ = { hash: new r, map: new(pe || u), string: new r } }

        function v(e) { return x(this, e).delete(e) }

        function m(e) { return x(this, e).get(e) }

        function b(e) { return x(this, e).has(e) }

        function w(e, t) { return x(this, e).set(e, t), this }
        ...
        function T(e, t) { t = I(t, e) ? [t] : _(t); for (var n = 0, o = t.length; null != e && n < o;) e = e[F(t[n++])]; return n && n == o ? e : void 0 }

        function k(e) { if (!U(e) || C(e)) return !1; var t = j(e) || o(e) ? Ae : ee; return t.test(V(e)) }

        function S(e) { if ("string" == typeof e) return e; if (O(e)) return ve ? ve.call(e) : ""; var t = e + ""; return "0" == t && 1 / e == -Q ? "-0" : t }

        function _(e) { return be(e) ? e : me(e) }

        function x(e, t) { var n = e.__data__; return R(t) ? n["string" == typeof t ? "string" : "hash"] : n.map }

        function P(e, t) { var o = n(e, t); return k(o) ? o : void 0 }

        function I(e, t) { if (be(e)) return !1; var n = typeof e; return !("number" != n && "symbol" != n && "boolean" != n && null != e && !O(e)) || (q.test(e) || !z.test(e) || null != t && e in Object(t)) }

        function R(e) { var t = typeof e; return "string" == t || "number" == t || "symbol" == t || "boolean" == t ? "__proto__" !== e : null === e }

        function C(e) { return !!le && le in e }

        function F(e) { if ("string" == typeof e || O(e)) return e; var t = e + ""; return "0" == t && 1 / e == -Q ? "-0" : t }

        function V(e) { if (null != e) { try { return ce.call(e) } catch (e) {} try { return e + "" } catch (e) {} } return "" }
        ...
        function j(e) { var t = U(e) ? de.call(e) : ""; return t == Z || t == H }

        function U(e) { var t = typeof e; return !!e && ("object" == t || "function" == t) }

        function G(e) { return !!e && "object" == typeof e }

        function O(e) { return "symbol" == typeof e || G(e) && de.call(e) == W }

        function M(e) { return null == e ? "" : S(e) }

        function N(e, t, n) { var o = null == e ? void 0 : T(e, t); return void 0 === o ? n : o }
        var D = "Expected a function",
            ...
            le = function() { var e = /[^.]+$/.exec(se && se.keys && se.keys.IE_PROTO || ""); return e ? "Symbol(src)_1." + e : "" }(),
            ce = ie.toString,
        ...
        var me = B(function(e) { e = M(e); var t = []; return J.test(e) && t.push(""), e.replace(X, function(e, n, o, r) { t.push(o ? r.replace($, "$1") : n || e) }), t });
        B.Cache = y;
    ...
    var o = n(15),
        r = function(e) {
            return new Promise(function(t, n) {
                ...
                r.parentNode.insertBefore(o, r), o.addEventListener("load", function(e) { e.currentTarget.classList.add("loaded"), t("api script tag created and loaded") }, !0), o.addEventListener("error", function(e) { n("Failed to load YouTube script: ", e) })
            })
        },
        i = function(e, t) {
            var n = e.target;
        ...
        a = function(e, t, n) {
            var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1,
                r = e.target,
                i = (r.getDuration() - t) / o,
                a = function e() { r.getCurrentTime() + .1 >= r.getDuration() && (r.pauseVideo(), r.seekTo(t), r.playVideo()), requestAnimationFrame(e) };
        ...
        s = function(e) {
            var t = e.container,
                ...
                A = function() {
                    return new n.YT.Player(d, {
                        ...
                        events: {
                            onReady: function(e) { i(e, s), c(e.target) },
            ...
            return new Promise(function(e, t) {
                var o = function t() { 1 === n.YT.loaded ? e(A()) : setTimeout(t, 100) };
                o()
            })
        };
    ...
    Y.use("node", function() {
        window.Singleton.create({
            ...
            bindUI: function() { this.dataToggleBody(), this.dataToggleEl(), this.dataLightbox(), this.scrollAnchors(), Y.one(window).on("resize", this.syncUI, this) },
            syncUI: function() { o(function() { r() }, 100, this) },
            folderNavExpand: function(e, t) {
                var n = Y.one(t);
                n && n.one(e).on("click", function() { n.toggleClass("expanded") })
            },
            folderActive: function(e, t) {
                e = e || ".folder-toggle", t = t || "body";
                var n = Y.all(t);
                n.size() > 0 && n.each(function(t) { t.delegate("click", function(e) { e.preventDefault(), e.currentTarget.toggleClass("active"), e.currentTarget.ancestor(".folder").siblings(".folder").each(function(e) { e.one(".folder-toggle").removeClass("active") }) }, e) })
            },
            ...
            dataLightbox: function() {
                ...
                Y.all("[data-lightbox]").each(function(t) {
                    ...
                    e[n] = e[n] || [], e[n].push({ content: t, meta: t.getAttribute("alt") }), t.on("click", function(o) { o.halt(), new Y.Squarespace.Lightbox2({ set: e[n], currentSetIndex: Y.all("[data-lightbox]").indexOf(t), controls: { previous: !0, next: !0 } }).render() })
                })
            },
    ...
    function n(e) { e = e || "img[data-src]", Y.one(e) && Y.all(e).each(function(e) { ImageLoader.load(e) }) } e.exports = n
}, function(e, t, n) {
    var o = n(2),
        r = n(26),
    ...
    i && Y.use("node", function(e) {
        window.Singleton.create({
            ready: function() { this.bindUI() },
            bindUI: function() {
                e.Global.on("tweak:change", function(t) { t.config && "Site Navigation" === t.config.category ? e.one("#mobileNavToggle").set("checked", !0) : e.one("#mobileNavToggle").set("checked", !1), "transparent-header" === t.getName() && o(function() { r() }, 100, this) });
